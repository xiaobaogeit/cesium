...
describe("Scene/PolygonClippingAcceleration", function () {
  it("no-op on empty data", function () {
    var grid;
    expect(function () {
      grid = new PolygonClippingAccelerationGrid({
        positions: [],
        indices: [],
        splits: 0,
        xIndex: 0,
  ...
  it("square with four splits is correctly generated", function () {
    // prettier-ignore
    const positions = [
          -1, 0, 1,             //     v0-|--v1  row0col0 (0) is PARTIAL
          1, 0, 1,              //     |0\| 1|   row0col1 (1) is TOTAL
          1, 0, -1,             //     -------   row1col0 (2) is TOTAL
          -1, 0, -1             //     |2 |\3|   row1col1 (3) is PARTIAL
